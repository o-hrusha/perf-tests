...
def buildCheckoutBody(session: Session): String = {
  ...
  val body =
    ...
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_name\"$nl$nl$userName$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_address\"$nl$nl$userAddress$nl" +
    s"$boundary$nlC@@ontent-Disposition: form-data; name=\"cart_postal\"$nl$nl$userPostal$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_city\"$nl$nl$userCity$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_country\"$nl$nl$userCountry$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_state\"$nl$nl$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_phone\"$nl$nl$userPhone$nl" +
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_email\"$nl$nl$userEmail$nl" +
