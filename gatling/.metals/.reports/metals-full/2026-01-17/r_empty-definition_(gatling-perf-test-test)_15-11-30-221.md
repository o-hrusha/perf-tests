error id: file:///C:/Users/Oleksandr_Hrusha/Desktop/PTF-Course/GATLING/gatling-perf-test/src/test/scala/api/cart.scala:scala/package.Seq.
...
val productParams: Seq[(String, String)] = cartContentMap.toSeq.flatMap { case (id, qty) =>
  Seq("p_id[]" -> id, "p_quantity[]" -> qty.toString)
    ...
    // Логируем formParams
    logger.info(s"[DEBUG] formParams: $formParams")
