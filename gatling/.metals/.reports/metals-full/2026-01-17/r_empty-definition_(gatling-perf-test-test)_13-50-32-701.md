...
def buildCheckoutBody(session: Session): String = {
  ...
  val body =
    ...
    s"$boundary$nlContent-Disposition: form-data; name=\"cart_postal\"$nl$nl$userPostal$nl" +
    s"$boundary$nlCo@@ntent-Disposition: form-data; name=\"cart_city\"$nl$nl$userCity$nl" +
